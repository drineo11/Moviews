		...
		<header>
			<nav id="main-navbar" class="navbar navbar-expand-lg">
				<a href="<?= $BASE_URL ?>" class="navbar-brand">
					<img src="<?= $BASE_URL ?>img/logo.png" alt="Moviews" id="logo">
				...
				<form action="<?= $BASE_URL ?>search.php" method="GET" id="search-form" class="form-inline my-0 my-lg-0">
					<input type="text" name="q" id="search" class="form-control" type="search" placeholder="Buscar Filmes" aria-label="Search">
