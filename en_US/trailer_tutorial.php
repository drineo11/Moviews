...
<div id="main-container" class="container-fluid">
	...
	<div id="trailer-container">
		...
		<form action="<?=$BASE_URL ?>newmovie.php" method="POST">
			<img src="<?= $BASE_URL ?>../assets/trailer_tutorial/en_US_01.png">
			<img src="<?= $BASE_URL ?>../assets/trailer_tutorial/en_US_02.png">
			<img src="<?= $BASE_URL ?>../assets/trailer_tutorial/en_US_03.png">
		</form>
	</div>
</div>
